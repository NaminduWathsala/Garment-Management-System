...
public class CustomerRegistration extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Customer Register.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Customer Update.png"))); // NOI18N
        ...
        jLabel21.setText("Update Customer :");

        jButton2.setFont(new java.awt.Font("Quicksand", 0, 22)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Customer Update.png"))); // NOI18N
        ...
        jTabbedPane2.addTab("Update Customer", jPanel6);
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/company register.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            try {
                ...
                MySQL.iud("UPDATE `customer` SET `name`= '" + name + "' ,`mobile`='" + mobile + "',`email`= '" + email + "' ,"
                        + "`nic`='" + nic + "' WHERE `id`='" + id + "' ");
