...
public class SelectSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.setBackground(new java.awt.Color(71, 181, 255));
        ...
        jLabel13.setFont(new java.awt.Font("Quicksand", 1, 20)); // NOI18N
        ...
        jPanel1.add(jTabbedPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 1170, 790));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                gr.jLabel10.setText(id);
                gr.jLabel12.setText(name);
                gr.jLabel15.setText(number);
                gr.jLabel17.setText(cbname);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (cname.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Please Enter Supplier Company Number", "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        } else if (cbnumber.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Enter Supplier Company Branch Number", "Warning", JOptionPane.WARNING_MESSAGE);
