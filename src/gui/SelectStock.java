 ...
 * @author namindu
 */
public class SelectStock extends javax.swing.JFrame {
...
//order by querry part
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                String stockid = jTable1.getValueAt(r, 0).toString();
                String supplyid = jTable1.getValueAt(r, 1).toString();
                String brand = jTable1.getValueAt(r, 2).toString();
                String type = jTable1.getValueAt(r, 3).toString();
                String ctype = jTable1.getValueAt(r, 4).toString();
                String name = jTable1.getValueAt(r, 5).toString();
                String colour = jTable1.getValueAt(r, 6).toString();
                String coy = jTable1.getValueAt(r, 7).toString();
                String wei = jTable1.getValueAt(r, 8).toString();
                String price = jTable1.getValueAt(r, 9).toString();

                in.jLabel33.setText(stockid);
                in.jLabel72.setText(supplyid);
                in.jLabel71.setText(brand);
                in.jLabel68.setText(type);
                in.jLabel75.setText(ctype);
                in.jLabel63.setText(colour);
                in.jLabel67.setText(name);
                in.jLabel78.setText(coy);
                in.jLabel80.setText(wei);
                in.jLabel76.setText(price);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectStock().setVisible(true);
            }
        });
    }
